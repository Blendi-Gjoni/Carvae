                ...
                >
                  ...
                  >
                    ...
                    <MDBRow className="g-0">
                      <MDBCol
                        md="4"
                        className="gradient-custom text-center text-white col-lg d-flex flex-column justify-content-evenly align-items-center"
                      >
                        <MDBIcon fas icon="user-astronaut" fluid size="5x" />
                        <MDBTypography tag="h5">
                          {user?.usernameF || "Username not available"}
                        </MDBTypography>
                        <MDBIcon
                          far
                          icon="edit"
